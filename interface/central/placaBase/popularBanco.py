...
from central.models import Configuracoes, Ambiente, Grandeza, Sensor, SensorGrandeza, SaidaDigital, Temporizador
...
# for x in range(24):
#     Temporizador(
#         horaLigar = dtTime(x, 00, 0, 0),
#         horaDesligar = dtTime(x, 00, 20, 0),
#         saidaDigital_id = 1
#     ).save()
#     Temporizador(
#         horaLigar = dtTime(x, 20, 0, 0),
#         horaDesligar = dtTime(x, 20, 20, 0),
#         saidaDigital_id = 1
#     ).save()
#     Temporizador(
#         horaLigar = dtTime(x, 40, 0, 0),
#         horaDesligar = dtTime(x, 40, 20, 0),
#         saidaDigital_id = 1
#     ).save()

for y in range(60):
    for z in range(1,60,5):
        Temporizador(
            horaLigar = dtTime(12, y, z-1, 0),
            horaDesligar = dtTime(12, y, z, 0),
            saidaDigital_id = 2
        ).save()