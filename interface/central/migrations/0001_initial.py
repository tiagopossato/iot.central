...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('horaLigar', models.TimeField(verbose_name='Hora de ligar')),
                ('horaDesligar', models.TimeField(verbose_name='Hora de desligar')),
                ('saidaDigital', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='central.SaidaDigital')),
            ],
            options={
